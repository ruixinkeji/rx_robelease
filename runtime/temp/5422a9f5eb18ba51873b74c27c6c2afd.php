<?php /*a:4:{s:75:"D:\ruixin_project\rx_robelease\application\admin\view\goods\goods-edit.html";i:1563776095;s:70:"D:\ruixin_project\rx_robelease\application\admin\view\public\base.html";i:1563238307;s:70:"D:\ruixin_project\rx_robelease\application\admin\view\public\meta.html";i:1563238307;s:72:"D:\ruixin_project\rx_robelease\application\admin\view\public\footer.html";i:1563330416;}*/ ?>
<!--引入html顶部meta和引用的css...-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<input type="hidden" id="imgUrl" name="imgUrl" value="<?php echo htmlentities($goods['goods_img']); ?>"/>
		<input type="hidden" id="goods_id" name="goods_id" value="<?php echo htmlentities($goods['goods_id']); ?>"/>
		<input type="hidden" id="goods_desc" name="" value="<?php echo htmlentities($goods['goods_desc']); ?>">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo htmlentities($goods['goods_name']); ?>" placeholder="商品标题" id="" name="goods_name">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="goods_category_id" class="select">
					...
					<option value="0" disabled><?php echo htmlentities($item['category_name']); ?></option>
						<?php if(is_array($item['categoryLev2']) || $item['categoryLev2'] instanceof \think\Collection || $item['categoryLev2'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['categoryLev2'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;if($goods['goods_category_id'] == $item2['category_id']): ?>
								<option selected value="<?php echo htmlentities($item2['category_id']); ?>">├<?php echo htmlentities($item2['category_name']); ?></option>
								<?php else: ?>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="<?php echo htmlentities($goods['goods_num']); ?>" placeholder="" id="" name="goods_num">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">商品价格(套/天)：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo htmlentities($goods['goods_current_price']); ?>" placeholder="" id="" name="goods_current_price">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="<?php echo htmlentities($goods['goods_lease_time']); ?>" placeholder="" id="" name="goods_lease_time">
