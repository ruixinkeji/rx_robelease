...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<?php if(is_array($permissions) || $permissions instanceof \think\Collection || $permissions instanceof \think\Paginator): $i = 0; $__LIST__ = $permissions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
				<dl class="permission-list">
					<dd>
						<dl class="cl permission-list2">
							<dt>
								<label class="">
									<input type="checkbox" value="" name="" id="user-Character-0-0"><?php echo htmlentities($item['name']); ?>
								</label>
							</dt>
							<dd>
								<?php if(is_array($item['permissions']) || $item['permissions'] instanceof \think\Collection || $item['permissions'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['permissions'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
								<label class="">
									<input type="checkbox" value="<?php echo htmlentities($item2['id']); ?>"  name="permission[]" id="user-Character-0-0-0"><?php echo htmlentities($item2['name']); ?>
								</label>
