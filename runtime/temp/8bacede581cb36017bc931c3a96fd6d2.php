<?php /*a:4:{s:78:"D:\ruixin_project\rx_robelease\application\admin\view\imgtext\banner-list.html";i:1563529253;s:70:"D:\ruixin_project\rx_robelease\application\admin\view\public\base.html";i:1563238307;s:70:"D:\ruixin_project\rx_robelease\application\admin\view\public\meta.html";i:1563238307;s:72:"D:\ruixin_project\rx_robelease\application\admin\view\public\footer.html";i:1563330416;}*/ ?>
<!--引入html顶部meta和引用的css...-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="picture_add('添加轮播','<?php echo url('admin/Imgtext/addBanner'); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加轮播</a></span> <span class="r">共有数据：<strong><?php echo htmlentities(count($banners)); ?></strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			<?php if(is_array($banners) || $banners instanceof \think\Collection || $banners instanceof \think\Paginator): $i = 0; $__LIST__ = $banners;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					<td><input name="" type="checkbox" value=""></td>
					<td><?php echo htmlentities($item['banner_id']); ?></td>
					<td>
						<div class="picbox">
							<a href="<?php echo htmlentities($item['banner_cover']); ?>" data-lightbox="gallery" data-title="图片">
								<img width="50" height="50" src="<?php echo htmlentities($item['banner_cover']); ?>">
							</a>
						</div>
					</td>
					<td><?php echo htmlentities($item['banner_name']); ?></td>
					<td><textarea cols="100" rows="5"><?php echo htmlentities($item['banner_describe']); ?></textarea></td>
					<?php if(($item['banner_status'] == 1)): ?>
					<td class="td-status"><span class="label label-success radius">已启用</span></td>
					<td class="td-manage"><a style="text-decoration:none" onClick="picture_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="picture_edit('轮播编辑','<?php echo url("admin/Imgtext/editBanner"); ?>','<?php echo htmlentities($item["banner_id"]); ?>')" href="javascript:;" title="轮播编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="picture_del(this,'10001')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					<?php else: ?>
